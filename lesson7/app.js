...
const currentDate = moment().locale(currentCulture, getCustomizationByCulture());
...
function renderCurrentDate() {
   const calendarCurrentDate = document.querySelector(".calendar-current-date");
    ...
    if (currentCulture === "kg"){
        calendarCurrentDate.innerText = moment.months()[currentDate.month()].format("MMMM YYYY").capitalize();
    }
}
